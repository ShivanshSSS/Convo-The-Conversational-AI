...
def select_file(voice_model):
    thalia = ["audio/thalia_interesting.mp3"] * 4
    odysseus = ["audio/odysseus_interesting.mp3"] * 4
    arcas = ["audio/arcas_interesting.mp3"] * 4
    andromea = ["audio/andromeda_interesting.mp3"] * 4
